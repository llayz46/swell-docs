...
- `pnpm run dev` : Compile les assets front-end avec Vite.
- `stripe listen --forward-to http://localhost:8000/stripe/webhook` : Écoute les événements Stripe et les redirige vers l'API de Swell.
