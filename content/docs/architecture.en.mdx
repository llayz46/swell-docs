...
- **`utils/`**: Utility functions
  ...
  - Helpers for formatting and data manipulation
...
All Inertia pages automatically receive props via `HandleInertiaRequests`:
...
**Advantage**: Essential data available everywhere without duplication
