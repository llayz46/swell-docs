...
<Callout>
    Swell imposes no business logic. The proposed models serve as an initial foundation, to be freely adapted. For any
    structure or behavior modification, refer to the official
...
<Callout>Collection allows associating multiple products together within the same collection.</Callout>
